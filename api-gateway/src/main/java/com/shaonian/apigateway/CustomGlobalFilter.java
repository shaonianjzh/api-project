package com.shaonian.apigateway;
...
//    private static final List<String> IP_WHITE_LIST = Arrays.asList("127.0.0.1");
    ...
    private static final String INTERFACE_HOST = "http://localhost:9800";
...
//        }
        ...
        //是否还有调用次数
        if (!innerUserInterfaceInfoService.isHaveCount(interfaceInfo.getId(),invokeUser.getId())) {
