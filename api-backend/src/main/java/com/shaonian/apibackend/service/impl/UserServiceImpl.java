...
import com.shaonian.apicommon.model.vo.UserVO;
...
import static com.shaonian.apibackend.constant.UserConstant.ADMIN_ROLE;
import static com.shaonian.apibackend.constant.UserConstant.USER_LOGIN_STATE;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User>
    ...
    public long userRegister(String userAccount, String userPassword, String checkPassword) {
        ...
        synchronized (userAccount.intern()) {
            ...
            List<UserInterfaceInfo> userInterfaceInfos = new ArrayList<>();
            for(InterfaceInfo interfaceInfo: interfaceInfos){
                ...
                userInterfaceInfos.add(userInterfaceInfo);
            }
            userInterfaceInfoService.saveBatch(userInterfaceInfos);
            return user.getId();
        }
    }
